...
public class ResearchAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = readObj.insertresearh(
				...
				request.getParameter("rproduct_id")
...
response.getWriter().write(output);
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = readObj.updateresearh(paras.get("hidItemIDSave").toString(), 
												...
												paras.get("rproduct_id").toString()
	...
	Map paras = getParasMap(request); 
		...
		String output = readObj.deleteresearh(paras.get("ID").toString()); 
		response.getWriter().write(output);
	}
